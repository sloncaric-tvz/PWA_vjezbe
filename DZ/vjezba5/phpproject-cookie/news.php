<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			setcookie('news_title_1', '_news_title_1', time() + 86400, '/');
			setcookie('link_news_title_1', 'index.php?menu=2&amp;action=1', time() + 86400, '/');
			setcookie('title_news_title_1', 'US growth faster than expected', time() + 86400, '/');
			print '
			...
			# inicijalizacija kolačića
			setcookie('news_title_2', '_news_title_2', time() + 86400, '/');
			setcookie('link_news_title_2', 'index.php?menu=2&amp;action=2', time() + 86400, '/');
			setcookie('title_news_title_2', 'Wall Street: Tech firm surge pushes US markets higher', time() + 86400, '/');
			print '
			...
			# inicijalizacija kolačića
			setcookie('news_title_3', '_news_title_3', time() + 86400, '/');
			setcookie('link_news_title_3', 'index.php?menu=2&amp;action=3', time() + 86400, '/');
			setcookie('title_news_title_3', 'Hotel booking sites probed by consumer watchdog', time() + 86400, '/');
			print '
