...
<body>
	...
	if (!empty($_COOKIE['news_title_1']) || !empty($_COOKIE['news_title_2']) || !empty($_COOKIE['news_title_3'])) {
		print '
		<aside><h2 style="text-align:center">ZADNJE PREGLEDANO</h2><ul>';
		# ispis vrijednosti $_COOKIE
		foreach($_COOKIE as $cookie){
			if(str_starts_with($cookie, '_')){
			print "
			<li style='border-bottom:2px dotted white;width:100%;'>
				<a href='".$_COOKIE['link'.$cookie]."' style='text-align:left;'>".$_COOKIE['title'.$cookie]."</a>
			</li>";
			}
		}
		print '
