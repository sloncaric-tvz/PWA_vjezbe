<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			$_SESSION['news_title_1'] = '_news_title_1';
			$_SESSION['link_news_title_1']='index.php?menu=2&amp;action=1';
			$_SESSION['title_news_title_1'] = 'US growth faster than expected';
			...
			$_SESSION['news_title_2'] = '_news_title_2';
			$_SESSION['link_news_title_2']='index.php?menu=2&amp;action=2';
			$_SESSION['title_news_title_2'] = 'Wall Street: Tech firm surge pushes US markets higher';
			...
			# inicijalizacija sjednice
			$_SESSION['news_title_3'] = '_news_title_3';
			$_SESSION['link_news_title_3']='index.php?menu=2&amp;action=3';
			$_SESSION['title_news_title_3'] = 'Hotel booking sites probed by consumer watchdog';
